...
use handlers::{auth as authHandler, users};
...
#[openapi(
    ...
    tags(
        (name = "Authentication Api (Actix Web)", description = "")
    )
)]
struct ApiDoc;

struct _SecurityAddon;

impl Modify for _SecurityAddon {
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(handlers::users::users_handler())
